          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-7">
              <div class="justify-content-center row">
                <p class="intro">
                  A to B Tyres Ltd is a family run business in Ipswich. We offer
                  a friendly and professional service supplying and fitting
                  tyres to enable you to keep your vehicle running smoothly,
                  efficiently, economically and legally. We carry an extensive
                  range of tyres which range from top premium tyres, mid-range
                  and budget tyres.
                </p>
